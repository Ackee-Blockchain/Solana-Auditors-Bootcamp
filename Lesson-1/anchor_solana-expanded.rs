...
pub mod program {
    ...
    pub struct AnchorSolana;
    #[automatically_derived]
    impl ::core::clone::Clone for AnchorSolana {
        #[inline]
        fn clone(&self) -> AnchorSolana {
            AnchorSolana
        }
    }
    impl anchor_lang::Id for AnchorSolana {
        fn id() -> Pubkey {
            ID
        }
    }
...
mod __private {
                        ...
                        anchor_lang::error::Error::from(anchor_lang::error::AnchorError {
                                ...
                                error_origin: Some(
                                    anchor_lang::error::ErrorOrigin::Source(anchor_lang::error::Source {
                                        filename: "programs/anchor_solana/src/lib.rs",
                                        line: 5u32,
                                    }),
                                ),
    ...
    pub mod __global {
        ...
        pub fn initialize<'info>(
            ...
            let result = anchor_solana::initialize(
